...
% 
% save('VDP_trained_network_dlnet.mat', 'dlnet')
% save('VDP_train_val_loss_dlnet.mat', 'trainLoss', 'valLoss', 'num_iters')

% Using a trained model
load("VDP_trained_network_dlnet.mat")
load("VDP_train_val_loss_dlnet.mat")
